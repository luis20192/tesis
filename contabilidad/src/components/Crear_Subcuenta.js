...
import validar from "./validarSub";

function Crear_Subcuenta() {
  ...
  function submit() {
      axios.post('http://localhost:3001/api/insert/subcuenta', {
    ...
    return (
        ...
        <h2 className="h2C" >Registrar nueva cuenta tipo Sub Cuenta</h2>
        ...
        <div className="Div2">
          ...
          <span className="CP2">Codigo de Cuenta "Padre"</span>
...
export default Crear_Subcuenta;