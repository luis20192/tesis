...
function Crear_Cuenta() {
  ...
  function submit () {
      axios.post('http://localhost:3001/api/insert/cuenta', {
    ...
    return (
        ...
        <h2 className="h2C" >Registrar nueva cuenta tipo Cuenta</h2>
        ...
        <div className="Div2">
          ...
          <span className="CP2">Codigo de Grupo "Padre"</span>
