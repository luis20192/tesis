export default function validar(values){
    ...
    } else if (values.codigo.length != 3) {
        errors.codigo = "Codigo debe tener 3 carácteres"
    ...
    } else if (values.codigo2.length != 2) {
        errors.codigo2 = "Codigo debe tener 2 carácteres"
